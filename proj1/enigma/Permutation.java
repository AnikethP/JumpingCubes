...
class Permutation {
    ...
    /**
     * Helper method to convert String cycle into arraylist.
     * @param cycle takes in a valid String representation of the permutation.
     */
    private void addCycle(String cycle) {
        ...
        for (int i = 0; i < cycle.length(); i++) {
            if (cycle.charAt(i) == ')') {
                _cycles.add(curr);
                curr = "";
            } else if (cycle.charAt(i) != ' ' && cycle.charAt(i) != '(') {
    ...
    /**
     * All cycles stored in an arraylist.
     */
