...
class Square {
     ...
     * (probably excessive).
     */
    private static final Square[][] ALLSQUARES = new Square[3][10];
    /**
    ...
    static Square square(Side side, int spots) {
        ...
        if (ALLSQUARES[side.ordinal()][spots] == null) {
            ALLSQUARES[side.ordinal()][spots] = new Square(side, spots);
        }
        return ALLSQUARES[side.ordinal()][spots];
    }
